%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% IEC Input File for `runIEC`
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% IEC Class Initializatin

params = IECDef(3,'C');      %Initialize IEC class, create params object
...
params.numSeeds= 6;                     % number of seeds - number of 10-minute simulations - for turbulent simulations
params.delay=29;                        % throw away this much simulated data at the beginning of each simulation (turbulent and otherwise)
params.SimTime=params.delay+600;        % total simulation time needed
params.NumGrid=10;                      % number of grid points in turbsim 4-D wind field
