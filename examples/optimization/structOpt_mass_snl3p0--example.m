...
designcriteria.MaxOoPDefl=7;
designcriteria.MaxFlapStrain=5000;
designcriteria.MinFlapStrain=-2000;
designcriteria.MaxEdgeStrain=7000;
designcriteria.MinEdgeStrain=-3000;
designcriteria.Mass = 80e3;   % kg
    bladeLength = 72; % m
    ratedRotorSpeed = 10; % rpm
designcriteria.FFreq = ratedRotorSpeed/60 * 3 * 1.1;  % for 13m rotor
designcriteria.EFreq = ratedRotorSpeed/60 * 3 * 1.1;  % for 13m rotor
...
while save_index < 10
    try
        ...
        fprintf(fid,'%s,(value/penalty),Flap Freq,%2.4f,%2.2f,Edge Freq,%2.4f,%2.2f,OoPDefl,%2.4f,%2.2f,FlapStrain,%.0f,%2.2f,FlapStrain,%.0f,%2.2f,EdgeStrain,%.0f,%2.2f,EdgeStrain,%.0f,%2.2f,Actual mass kg,%6.0f,fitness function,%6.0f\n',datestr(now),params);
        fclose(fid);
        break
    catch
