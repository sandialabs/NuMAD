...
elseif contains(designNuMADfolder,'s2-baselineCF')
    ...
    sparMaterialIndex = 6;    
    % set optimization variable limits    
    ub = [400; 50; 50; 50; 20; 10];
    lb = [100; 1; 1; 1; 1; 1];
    % initial blade variable values
    sparSpan = [0 0.25 0.5 0.75 0.97 1]';
    sparLayers = [1 10 18 1 1 1]'; 
    sparCapWidth = 200;
...
return
structOpt_mass_allCases(blade,lb,ub,A,b,pop,gen,restartFile,useParallel)
