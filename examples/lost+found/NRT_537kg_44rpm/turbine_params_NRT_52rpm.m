...
GenSpeedSPHigh = 1433;%1210;
GenSpeedSPLow = 400;
GenSpeedSPVOG = 1650;%1500; % Set point for Vestas Overspeed Guard (VOG) Test(rpm)
...
ProductionTorqueCpMax = 514.8; % Torque at GenSpeedSPHigh for Optimal power extraction (see above).
