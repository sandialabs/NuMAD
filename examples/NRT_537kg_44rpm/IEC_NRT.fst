...
---------------------- BLADE ---------------------------------------------------
"NRTblade_precomp.dat" BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"NRTblade_precomp.dat" BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"NRTblade_precomp.dat" BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"IEC_NRT_AD.ipt" ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
...
0.965            NcIMUxn     - Downwind distance from the tower-top to the nacelle IMU (meters)
0                NcIMUyn     - Lateral  distance from the tower-top to the nacelle IMU (meters)
0.63             NcIMUzn     - Vertical distance from the tower-top to the nacelle IMU (meters)
