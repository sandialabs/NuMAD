function [output,outputAllFiles]=runIECDLC1p4(params,output)
global fastPath
global adamsPath  
...
% %         ad.WindFile=['"' params.parDir 'wind\' ctr.windLabels{ii} '"'];
        ...
        fst.SimCtrl.TMax=100;%params.delay+100;%ble: fix for numerical errors around 90-sec.  fst.SimCtrl.TMax=100;
