function [] = initOpt_mass_snl3p0_allCases_noSparCapWidth_buckle(designNuMADfolder, bladeFile)
% close all; clear all; clc

%% ************************************************************************
% Define the starting blade file to read in design details
% *************************************************************************
% designNuMADfolder = 'C:\data\SNL3p0-148-mk0p2-s1-fiberglass\NuMAD';
...
%% fix balsa orthotropic properties
balsaMat = 4;
blade.materials(balsaMat).pryz = 0.1;
blade.materials(balsaMat).prxz = 0.1;
...
structOpt_mass_SNL3p0_noSparCapWidth_buckle(blade,lb,ub,A,b,pop,gen,restartFile,useParallel)
