function writeFastADmod(ad,output_file)
%WRITEFASTADmod  Write a FAST Aerodyn input file; used for modified versions of AeroDyn
% **********************************************************************
% *                   Part of the SNL NuMAD Toolbox                    *
% * Developed by Sandia National Laboratories Wind Energy Technologies *
% *             See license.txt for disclaimer information             *
% **********************************************************************
%   writeFastADmod(ad,output_file) 
% 
%      ad = AeroDyn data structure; view default structure by utilizing 
%           readFastADmod()
%      output_file = name of file to be created.
% 
%   ** This is a version of writeFastAD() that is able to write input files
...
wip(fid,ad.UFModel,       '(SNL Custom Option) Leishman unsteady flap model usage [True or False] (unquoted string)')
